...
export default function Navbar({ user }: { user: UserPayload }) {
  ...
  const handleCreatePost = () => {
      ...
      router.push(`/create-post/${newSlug}`);
    };
    ...
    <nav className="bg-white border-b border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="md:hidden flex justify-center space-x-8 pb-3 border-t border-gray-200 mt-2 pt-3">
          <Button variant="ghost" className="flex flex-col" asChild>
              <Link href="/">
          ...
          <Button variant="ghost" size="sm" className="flex flex-col" onClick={handleCreatePost}>
